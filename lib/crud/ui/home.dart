...
import 'package:aa/crud/ui/entryform.dart';
import 'package:aa/crud/models/contact.dart';
import 'package:aa/crud/helpers/dbhelper.dart';
      ...
      itemBuilder: (BuildContext context, int index) {
        return Card(
          ...
          child: ListTile(
            ...
            title: Text(
              this.contactList[index].namakendaraan,
              style: textStyle,
            ),
            subtitle: Text(this.contactList[index].waktusewa),
